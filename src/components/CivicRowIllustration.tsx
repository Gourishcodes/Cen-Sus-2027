import { INDIA_OUTLINE_PATH } from "../data/indiaOutline";
...
export default function CivicRowIllustration() {
  return (
    ...
    >
      ...
      {/* Official GeoJSON Projected Geographic Map Silhouette Watermark */}
      <g opacity="0.08" transform="translate(240, 10) scale(0.24)" fill="currentColor" stroke="none">
